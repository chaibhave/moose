# Transient constant-source diffusion on the checked-in 100-grain mesh.
# MooseUnits documents each dimensional input and converts it to SI.
length = ${units 200 mum -> m}
center_y = ${units 25 mum -> m}
...
[VectorPostprocessors]
  [centerline_profile]
    ...
    variable = c
    start_point = '0 ${center_y} 0'
    end_point = '${length} ${center_y} 0'
    num_points = 201
    sort_by = id
...
[Outputs]
  file_base = polycrystal_transient
  [csv]
    type = CSV
