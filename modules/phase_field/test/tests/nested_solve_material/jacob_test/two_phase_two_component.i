...
[Mesh]
  type = GeneratedMesh
  dim = 1
  nx = 100 #0 #${fparse int ( 10 * ( ${xmax} - ${xmin} ) ) }
  ny = 15
  nz = 0
  xmin = 0
  xmax = 10 #0 #0
...
[GlobalParams]
  ...
  # profile = TANH
  x_Cr_BC = 2.5e-6
  x_Ni_BC = 4e-9 ##0.0000000080108391
...
[Functions]
  ...
  [c_Ni_BC_func]
    type = ParsedFunction
    expression = '8.0e-9 - (8.0e-9 - ${GlobalParams/x_Ni_BC} )*tanh(t)'
  []
  [c_Cr_BC_func]
    type = ParsedFunction
    expression = '0.0000000080108391 - (0.0000000080108391 - ${GlobalParams/x_Cr_BC})*tanh(t)'
  []
  [w_Ni_BC_func]
    type = ParsedFunction
...
[Materials]
  ...
  [f_metal]
    ...
    expression = '(8090.0085*x_cr_m*plog(x_cr_m,1e-12) - 151569.384260127*x_cr_m + 8090.0085*x_ni_m*plog(x_ni_m,1e-12) - 166834.442737411*x_ni_m + 8090.0085*(-x_cr_m - x_ni_m + 1)*plog(-x_cr_m - x_ni_m + 1,1e-12) + 123820.210087488)/96500'
    # expression = '(x_cr_m*x_ni_m*(10523.5652 - 27907.1252*x_ni_m) + 8090.0085*x_cr_m*log(x_cr_m) - 151569.384260127*x_cr_m + 8090.0085*x_ni_m*log(x_ni_m) - 166834.442737411*x_ni_m + 8090.0085*(-x_cr_m - x_ni_m + 1)*log(-x_cr_m - x_ni_m + 1) + 8090.0085*(5.64178064301999e-79*(-3605*x_cr_m*x_ni_m - 1109*x_cr_m + 633*x_ni_m)^25 + 2.04326786303716e-48*(-3605*x_cr_m*x_ni_m - 1109*x_cr_m + 633*x_ni_m)^15 + 4.89513034938089e-17*(-3605*x_cr_m*x_ni_m - 1109*x_cr_m + 633*x_ni_m)^5)*log(-1.91*x_cr_m*x_ni_m - 2.46*x_cr_m + 0.528*x_ni_m + 1) + 123820.210087488)/96500'
  ...
  [f_melt]
    ...
    expression = '(8089.9721271854*x_cr_s*plog(x_cr_s,1e-12) + x_cr_s*(164050.988348729 - 26181.484*log(973)) + 8089.9721271854*x_ni_s*plog(x_ni_s,1e-12) + x_ni_s*(253092.124999596 - 21499.408*log(973)) + 8089.9721271854*(-x_cr_s - x_ni_s + 1)*plog(-x_cr_s - x_ni_s + 1,1e-12))/96500'
    material_property_names = 'x_cr_m x_ni_m x_cr_s x_ni_s'
    additional_derivative_symbols = 'x_cr_m x_ni_m x_cr_s x_ni_s'
    derivative_order = 3
    compute = false
  ...
  [M_Ni]
    ...
    expression = '2e-4*h/d2f_metal + 10*h2/d2f_melt'
  ...
  [constants]
    ...
    prop_values = '1e-4 1e-1 0.4'
  []
  # [M_Ni]
  #   type = DerivativeParsedMaterial
  #   material_property_names = 'd2f_metal/d2x_ni_m d2f_melt/d2x_ni_s h h2'
  #   expression = '1e-4*(h/(d2f_metal/d2x_ni_m) + h2/(d2f_melt/d2x_ni_s) )'
  # []
[]
