...
class NestedKKSMultiPhaseMaterial : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  NestedKKSMultiPhaseMaterial(const InputParameters & parameters);
...
protected:
  ...
  virtual Real update_guess(const NestedSolve::Value<> & guess);
