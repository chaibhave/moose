...
protected:
  ...
  /// Vector to hold list of material names that must be updated prior to evaluating current material (for compute = false materials)
  ...
  /// Vector to hold list of materials that must be updated prior to evaluating current material (for compute = false materials)
